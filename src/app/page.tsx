    ...
    <>
      ...
      <div className="w-full h-screen  bg-gradient-to-r from-fuchsia-600 to-purple-600 mx-auto flex items-center -mt-6 pt-16 p-2 flex-col">
        ...
        <div className="flex gap-4 w-full h-full flex-col md:flex-row">
          ...
          <div className="w-full md:w-7/12 bg-white/65 rounded-[48px] h-1/2 md:h-full flex items-center flex-col justify-center overflow-hidden object-contain object-center">
            <img
              ...
              return (
                <SwiperSlide key={member.id}>
                  <div className="w-64 mx-auto bg-white/30 backdrop-blur-md rounded-md p-4 flex  flex-col items-center">
                    <div className="w-36 h-36  rounded-full overflow-hidden mt-2 object-center">
                      <img
                        src={
                          member.image ||
